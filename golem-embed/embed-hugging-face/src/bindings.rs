...
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:component:embed-hugging-face:example:encoded world"
)]
#[doc(hidden)]
...
@\0\0s\x04\0\x0bhello-world\x01\0\x04\0$component:embed-hugging-face/example\x04\
